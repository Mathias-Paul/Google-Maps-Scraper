...
#         print('''Google has silently blocked your IP. Contact IT asap; then follow these Steps to try and change your IP.
# # If using Wifi:
...
if __name__ == "__main__":
    # scrape_places({'query': 'Restaurant in Miami', 'max': 1, 'lang': None, 'geo_coordinates': '', 'zoom': 14, 'links':[]})
    # scrape_places({'query': 'Restaurant in Miami', 'max': 1, 'lang': None, 'geo_coordinates': '', 'zoom': 14, 'links':[]})
    print(scrape_places({'query': 'Real Estate Agents   in Miami', 'max': 1, 'lang': 'hi', 'geo_coordinates': '', 'zoom': 14, 'links':[]}))
    # print(scrape_place(["https://www.google.com/maps/place/Pla%C3%A7a+de+la+Reina+Sofia/@38.9064317,1.4319022,1246m/data=!3m1!1e3!4m14!1m7!3m6!1s0xd63fd22e0c22e1f:0xc2d606310f68bc26!2sHisn+Yakka!8m2!3d38.6089019!4d-1.1214893!16s%2Fg%2F11p06xtf82!3m5!1s0x129946ba9a1e5835:0xe124b3bae1c14728!8m2!3d38.9074875!4d1.4332642!16s%2Fg%2F11cjgdf7vy?authuser=0&entry=ttu&g_ep=EgoyMDI0MDgyMy4wIKXMDSoASAFQAw%3D%3D"] , metadata={}))b