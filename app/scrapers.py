...
Server.configure(
    ...
    header_title="Mennr Made",
    description="Extract thousands of new leads.",
    right_header={
        "text": "Love It? Star It! ★",
        "link": "https://github.com/mathias-paul/google-maps-scraper",
    },
)
# python -m backend.scrapers
if __name__ == "__main__":
    # print(split_by_gmaps_search_links(["https://www.google.com/maps/search/sushi+restaurants+chicago/@41.9195458,-87.7138893,17242m/data=!3m2!1e3!4b1?entry=ttu&g_ep=EgoyMDI0MDgyMy4wIKXMDSoASAFQAw%3D%3D", "https://www.google.com/maps/search/S%C3%BCss+Cookie+Company/@40.5068471,-111.4753885,1101m/data=!3m1!1e3?entry=ttu&g_ep=EgoyMDI0MDgyMy4wIKXMDSoASAFQAw%3D%3D"]))
    print(process_domain("www.mennr.tech"))